...
<form method='post' action='" . e_SELF . "' id='dataform' >
	...
	<tr>
		<td class='fcaption' colspan='2' style='text-align:left'>" . LAN_PLUGIN_GOLD_SYS__MS01 . "</td>
	</tr>
	<tr>
		<td class='forumheader3' style='width:30%'>" . LAN_PLUGIN_GOLD_SYS__MS03 . "</td>
	...
	<tr>
		<td class='forumheader2' colspan='2' style='text-align:left'>
			<input type='submit' class='button' name='updatesettings' value='" . LAN_PLUGIN_GOLD_SYS__MS02 . "' />
		</td>
	</tr>
	<tr>
