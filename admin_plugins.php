...
if (isset($_POST['updatesettings']))
{
    ...
    $gold_obj->save_prefs();
    $gold_msg = LAN_PLUGIN_GOLD_SYS__MP11;
}
#print_a($_POST);
// *****************************************************************************************************
// *
...
<table class="fborder" style="' . ADMIN_WIDTH . '" >
	<tr>
		<td class="fcaption" colspan="7" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__MP01 . '</td>
	</tr>
	<tr>
		<td class="forumheader2" colspan="7" style="text-align:left"><b>' . $gold_msg . '</b>&nbsp;</td>
	</tr>
	<tr>
		<td class="forumheader2" style="width:15%;text-align:left"><b>' . LAN_PLUGIN_GOLD_SYS__MP02 . '</b></td>
		<td class="forumheader2" style="width:7%;text-align:center"><b>' . LAN_PLUGIN_GOLD_SYS__MP17 . '</b></td>
		<td class="forumheader2" style="width:7%;text-align:center"><b>' . LAN_PLUGIN_GOLD_SYS__MP13 . '</b></td>
		<td class="forumheader2" style="width:23%;text-align:left"><b>' . LAN_PLUGIN_GOLD_SYS__MP14 . '</b></td>
		<td class="forumheader2" style="width:34%;text-align:left"><b>' . LAN_PLUGIN_GOLD_SYS__MP15 . '</b></td>
		<td class="forumheader2" style="width:7%;text-align:center"><b>' . LAN_PLUGIN_GOLD_SYS__MP10 . '</b></td>
		<td class="forumheader2" style="width:7%;text-align:center"><b>' . LAN_PLUGIN_GOLD_SYS__MP04 . '</b></td>
	</tr>';
	...
	<tr>
        ...
        else
        {
            ...
            <td class="forumheader3" style="text-align:center">&nbsp;</td>
		<td class="forumheader3" style="text-align:center" colspan="2">' . LAN_PLUGIN_GOLD_SYS__MP16 . '</td>';
        }
        $gold_text .= '
		<td class="forumheader3" style="text-align:center">
		...
		<td class="forumheader3" style="text-align:center"><a href="' . e_SELF . '?gold_edit.' . $key['plug_folder'] . '" ><img src="' . e_IMAGE . 'admin_images/edit_16.png" alt="' . LAN_PLUGIN_GOLD_SYS__MP18 . '" title="' . LAN_PLUGIN_GOLD_SYS__MP18 . '" /></a></td>
	</tr>';
    }
    $gold_text .= '
	<tr>
		<td class="forumheader2" colspan="7" style="text-align:left">
			<input type="submit" class="button" name="updatesettings" value="' . LAN_PLUGIN_GOLD_SYS__MP12 . '" />
		</td>
	</tr>
	<tr>
