...
if (isset($_POST['updatesettings']))
{
    ...
    $gold_msg = LAN_PLUGIN_GOLD_SYS__F60;
}
...
for ($j = 1; $j <= 2; $j++)
{
	...
	<option value="avatar"' . $avatar_s[$j] . '>' . LAN_PLUGIN_GOLD_SYS__F71 . '</option>';
}

for ($k = 3; $k <= 12; $k++)
{
    $forum_layout_2[$k] = '<option></option>
	<option value="stars"' . $stars_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F72 . '</option>
	<option value="rank"' . $rank_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F73 . '</option>
	<option value="moderator"' . $moderator_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F74 . '</option>
	<option value="member"' . $member_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F75 . '</option>
	<option value="rpg"' . $rpg_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F76 . '</option>
	<option value="joined"' . $joined_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F77 . '</option>
	<option value="location"' . $location_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F78 . '</option>
	<option value="posts"' . $posts_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F79 . '</option>
	<option value="gold"' . $gold_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F80 . '</option>
	<option value="spent"' . $spent_s[$k] . '>' . LAN_PLUGIN_GOLD_SYS__F81 . '</option>';
}
...
<form method="post" action="' . e_SELF . '" id="gold_form" >
	<table class="fborder" style="' . ADMIN_WIDTH . '" >
		<tr>
			<td class="fcaption" colspan="2" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F84 . '</td>
		</tr>
		<tr>
			<td class="forumheader2" colspan="2" style="text-align:left"><b>' . $gold_msg . '</b>&nbsp;</td>
		</tr>
				<tr>
			<td class="forumheader3"  style="width:30%;text-align:left">' . LAN_PLUGIN_GOLD_SYS__F01 . '</td>
			...
			<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__33 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="radio"' . $post_checked . 'name="gold_reward_type" class="tbox"  value="post" /> ' . LAN_PLUGIN_GOLD_SYS__34 . '<br />
			<input type="radio"' . $length_checked . 'name="gold_reward_type" class="tbox" value="length" /> ' . LAN_PLUGIN_GOLD_SYS__35 . '
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F02 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_threadmin" value="' . $GOLD_PREF['gold_threadmin'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F40 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_newthread_post" value="' . $GOLD_PREF['gold_newthread_post'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F41 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_reply_post" value="' . $GOLD_PREF['gold_reply_post'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F04 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_newthread_length" value="' . $GOLD_PREF['gold_newthread_length'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F05 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_reply_length" value="' . $GOLD_PREF['gold_reply_length'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F03 . '</td>
		<td class="forumheader3" style="width:70%">
			<input type="text" class="tbox" name="gold_threadbonus" value="' . $GOLD_PREF['gold_threadbonus'] . '" />
		</td>
	</tr>
	<tr>
		<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__F06 . '</td>
		<td class="forumheader3" style="width:70%">
	...
	<tr>
		<td class="forumheader2"  style="width:30%;text-align:left"><b>' . LAN_PLUGIN_GOLD_SYS__F86 . '</b></td>
		<td class="forumheader2"  style="width:70%;text-align:left"><b>' . LAN_PLUGIN_GOLD_SYS__F87 . '</b></td>
	</tr>
	<tr>
		<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 1</td>
		<td class="forumheader3">
			<select class="tbox" name="forum_layout_1">' . $forum_layout_1[1] . '</select>
		</td>
	</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 2</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_2">' . $forum_layout_1[2] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 3</td>
			<td class="forumheader3">
				<select  class="tbox" name="forum_layout_3">' . $forum_layout_2[3] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 4</td>
			<td class="forumheader3">
				<select  class="tbox" name="forum_layout_4">' . $forum_layout_2[4] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 5</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_5">' . $forum_layout_2[5] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 6</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_6">' . $forum_layout_2[6] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 7</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_7">' . $forum_layout_2[7] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 8</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_8">' . $forum_layout_2[8] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 9</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_9">' . $forum_layout_2[9] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 10</td>
			<td class="forumheader3">
				<select  class="tbox" name="forum_layout_10">' . $forum_layout_2[10] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 11</td>
			<td class="forumheader3">
				<select class="tbox"  name="forum_layout_11">' . $forum_layout_2[11] . '</select>
			</td>
		</tr>
		<tr>
			<td class="forumheader3"  style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__F85 . ' 12</td>
			<td class="forumheader3">
