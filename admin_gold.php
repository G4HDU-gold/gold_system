...
if (isset($_POST['addgold']))
{
    ...
    if ($_POST['gold_user_gold'] > 0)
    {
        ...
        $gold_param['gold_log'] = $tp->toDB(LAN_PLUGIN_GOLD_SYS__M015 . ' ' . $GOLD_PREF['gold_currency_name'] . ' : ' . $_POST['gold_comment']);

        $fred = $gold_obj->gold_modify($gold_param);

        $gold_msg = LAN_PLUGIN_GOLD_SYS__M016 . ' ' . $GOLD_PREF['gold_currency_name'];
        $gold_action = '';
    }
    else
    {
        $gold_msg = LAN_PLUGIN_GOLD_SYS__M017;
        $gold_action = 'edit';
    }
}
if (isset($_POST['deductgold']))
{
    ...
    if ($_POST['gold_user_gold'] > 0)
    {
        ...
        $gold_param['gold_plugin'] = 'gold_system';
        $gold_param['gold_log'] = $tp->toDB(LAN_PLUGIN_GOLD_SYS__M018 . ' ' . $GOLD_PREF['gold_currency_name'] . ' : ' . $_POST['gold_comment']);
...
<form method="post" action="' . e_SELF . '" id="gold_form" >
	<div>
 	...
 	<table class="fborder" style="' . ADMIN_WIDTH . '">
 		<tr>
 			<td class="fcaption" colspan="2" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__MM01 . '</td>
 		</tr>
 		<tr>
 			<td class="forumheader2" colspan="2" style="text-align:left"><b>' . $gold_msg . '</b>&nbsp;</td>
 		</tr>
 		<tr>
 			<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__M57 . '</td>
 			<td class="forumheader3" style="width:70%">' . $tp->toHTML($user_name) . '</td>
 		</tr>
 		<tr>
 			<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__M020 . '</td>
 			<td class="forumheader3" style="width:70%">' . $gold_obj->formation($gold_obj->gold_balance($gold_uid)) . '</td>
 		</tr>
 		<tr>
 			<td class="forumheader3" style="width:30%">' . $GOLD_PREF['gold_currency_name'] . ' ' . LAN_PLUGIN_GOLD_SYS__M021 . '</td>
 			<td class="forumheader3" style="width:70%">
 				<input class="tbox" type="text" size="25" maxlength="10" name="gold_user_gold" value="' . $_POST['gold_user_gold'] . '"/>
 			</td>
 		</tr>
 		<tr>
 			<td class="forumheader3" style="width:30%">' . LAN_PLUGIN_GOLD_SYS__M012 . '</td>
 			<td class="forumheader3" style="width:70%">
 		...
 		<tr>
 			<td class="forumheader2" colspan="2" style="text-align:center">
 				<input type="submit" class="button" name="addgold" onclick=\'return confirm("' . LAN_PLUGIN_GOLD_SYS__M013 . '")\' value="' . LAN_PLUGIN_GOLD_SYS__M22 . ' ' . $GOLD_PREF["gold_currency_name"] . '" />
 				<input type="submit" class="button" name="deductgold" onclick=\'return confirm("' . LAN_PLUGIN_GOLD_SYS__M014 . '")\' value="' . LAN_PLUGIN_GOLD_SYS__M23 . ' ' . $GOLD_PREF["gold_currency_name"] . '" />
 			</td>
 		</tr>
 	</table>
</form>';
...
<form method="post" action="' . e_SELF . '" id="gold_form" >
	...
	<table class="fborder" style="' . ADMIN_WIDTH . '">
		<tr>
			<td class="fcaption" colspan="6" style="text-align:left">' . LAN_PLUGIN_GOLD_SYS__M001 . '</td>
		</tr>
		<tr>
			<td class="forumheader2" colspan="6" style="text-align:left"><b>' . $gold_msg . '</b>&nbsp;</td>
		</tr>
		<tr>
			<td class="forumheader2" style="width:10%;text-align:right;" >' . LAN_PLUGIN_GOLD_SYS__M002 . '</td>
			<td class="forumheader2" style="width:30%;text-align:left;">' . LAN_PLUGIN_GOLD_SYS__M003 . '</td>
			<td class="forumheader2" style="width:15%;text-align:right;">' . LAN_PLUGIN_GOLD_SYS__M004 . '</td>
			<td class="forumheader2" style="width:15%;text-align:right;">' . LAN_PLUGIN_GOLD_SYS__M005 . '</td>
			<td class="forumheader2" style="width:15%;text-align:right;">' . LAN_PLUGIN_GOLD_SYS__M006 . '</td>
			<td class="forumheader2" style="width:15%;text-align:center;">' . LAN_PLUGIN_GOLD_SYS__M007 . '</td>
		</tr>	';
    while ($gold_row = $sql->db_Fetch())
    {
		...
		<tr>
			...
			<td class="forumheader3" style="text-align:center;" >
				<a href="' . e_SELF . '?' . $gold_from . '.edit.' . $gold_row['gold_id'] . '" ><img src="' . e_IMAGE . 'admin_images/edit_16.png" alt="' . LAN_PLUGIN_GOLD_SYS__M010 . '" title="' . LAN_PLUGIN_GOLD_SYS__M010 . '" /></a>&nbsp;
				<a href="' . e_SELF . '?' . $gold_from . '.history.' . $gold_row['gold_id'] . '" ><img src="' . e_IMAGE . 'admin_images/prefs_16.png" alt="' . LAN_PLUGIN_GOLD_SYS__M011 . '" title="' . LAN_PLUGIN_GOLD_SYS__M011 . '" /></a></td>
		</tr>';
    }
    $action = 'show';
    ...
    $gold_text .= '
		<tr>
			<td class="forumheader2" colspan="6" style="text-align:center">' . LAN_PLUGIN_GOLD_SYS__M009 . '&nbsp;
				<input type="text" class="tbox" style="width:140px;" name="gold_user" value="' . $_POST['gold_user'] . '" /> &nbsp;&nbsp;
				<input type="submit" class="button" name="gold_update" value="' . LAN_PLUGIN_GOLD_SYS__M008 . '" /></td>
		</tr>
	<tr>
