...
{
    case "AUD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP11;
        break;
    case "CAD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP12;

        break;
    case "CHF":
        $retval=LAN_PLUGIN_GOLD_SYS__PP13;
        break;
    case "CZK":
        $retval=LAN_PLUGIN_GOLD_SYS__PP14;
        break;
    case "DKK":
        $retval=LAN_PLUGIN_GOLD_SYS__PP15;
        break;
    case "EUR":
        $retval=LAN_PLUGIN_GOLD_SYS__PP16;
        break;
    case "GBP":
        $retval=LAN_PLUGIN_GOLD_SYS__PP17;
        break;
    case "HKD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP18;
        break;
    case "HUF":
        $retval=LAN_PLUGIN_GOLD_SYS__PP19;
        break;
    case "JPY":
        $retval=LAN_PLUGIN_GOLD_SYS__PP20;
        break;
    case "NOK":
        $retval=LAN_PLUGIN_GOLD_SYS__PP21;
        break;
    case "NZD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP22;
        break;
    case "PLN":
        $retval=LAN_PLUGIN_GOLD_SYS__PP23;
        break;
    case "SEK":
        $retval=LAN_PLUGIN_GOLD_SYS__PP24;
        break;
    case "SGD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP25;
        break;
    case "USD":
        $retval=LAN_PLUGIN_GOLD_SYS__PP26;
        break;
    case "ILS":
        $retval=LAN_PLUGIN_GOLD_SYS__PP27;
        break;
    case "MXN":
        $retval=LAN_PLUGIN_GOLD_SYS__PP28;
        break;
}
return $retval;
SC_END
